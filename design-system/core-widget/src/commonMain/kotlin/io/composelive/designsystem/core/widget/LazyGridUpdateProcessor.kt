 ...
 */
public abstract class LazyGridUpdateProcessor<V : Any, W : Any> {
    ...
    public val items: Widget.Children<W> = object : Widget.Children<W> {
        ...
        override fun detach() {
            ...
            this@LazyGridUpdateProcessor.detach()
        }
    }
    ...
    private fun requireBindingAtIndex(index: Int): Binding<V, W> {
        fun createBinding() = Binding(
            processor = this@LazyGridUpdateProcessor,
            isPlaceholder = true,
        ).apply {
        ...
        return when {
            ...
            else -> itemsAfter.getOrCreate(
                index - itemsBefore.size - loadedItems.size,
                ::createBinding
            )
        }
    }
    ...
    public class Binding<V : Any, W : Any> internal constructor(
        public val processor: LazyGridUpdateProcessor<V, W>,
