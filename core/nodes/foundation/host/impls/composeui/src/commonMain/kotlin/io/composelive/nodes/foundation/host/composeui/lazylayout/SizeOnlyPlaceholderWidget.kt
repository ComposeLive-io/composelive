...
public class SizeOnlyPlaceholderWidget(
    ...
    override fun contentAlignment(contentAlignment: Alignment) {}

    override fun propagateMinConstraints(propagateMinConstraints: Boolean) {}
