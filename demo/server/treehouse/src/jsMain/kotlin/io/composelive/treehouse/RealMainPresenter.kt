...
import io.composelive.MainTreehouseUi
import io.composelive.nodes.standard.protocol.guest.StandardProtocolWidgetSystemFactory
import io.composelive.presentation.Navigator
...
class RealMainPresenter(
    ...
    override val appLifecycle = StandardAppLifecycle(
        protocolWidgetSystemFactory = StandardProtocolWidgetSystemFactory,
        json = json,
        widgetVersion = 0U,
    )
