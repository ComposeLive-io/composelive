...
public class ScrollOptimizedLoadingStrategy(
    ...
    override val isScrollingDown: Boolean by derivedStateOf {
        firstIndexFromPrevious1 != DEFAULT_SCROLL_INDEX &&
                firstIndexFromPrevious1 < firstVisibleIndex
    }
    override val isScrollingUp: Boolean by derivedStateOf {
        firstIndexFromPrevious1 != DEFAULT_SCROLL_INDEX &&
                firstIndexFromPrevious1 > firstVisibleIndex
    }
    ...
    public override fun loadRange(itemCount: Int): IntRange {
        ...
        val hasStoppedScrolling =
            firstIndexFromPrevious2 != DEFAULT_SCROLL_INDEX && firstVisibleIndex == firstIndexFromPrevious1
